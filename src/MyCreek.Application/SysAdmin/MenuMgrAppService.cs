...
namespace MyCreek.SysAdmin
{
    public class MenuMgrAppService : MyCreekAppServiceBase, IMenuMgrAppService
    {
        ...
        public MenuMgrAppService(IMenuMgrRepository menuRepository)
        {
        ...
        public async Task UpdateMenuTemplate(TemplateInput input)
        {
            if (input.MenuGuid>0)
            {
                var menuItemDefine = await _menuRepository.SingleAsync(c => c.Id == input.MenuGuid);
                if (menuItemDefine != null)
                {
        ...
        public Task<FieldDto> GetField(FieldDto input)
        {
            throw new NotImplementedException();
        }

        public Task DeleField(int id)
        {
            throw new NotImplementedException();
        }

        public Task<CustomFeatureCoreStructDto> GetMenuInfo(string menuGuid)
        {
            throw new NotImplementedException();
        }

        public Task CreateCustomFeatureStruct(string menuGuid)
        {
            throw new NotImplementedException();
        }

        public Task SetMenuStatus(string menuGuid)
        {
            throw new NotImplementedException();
        }

        public Task<string> GetMenuStatus()
        {
            throw new NotImplementedException();
        }
