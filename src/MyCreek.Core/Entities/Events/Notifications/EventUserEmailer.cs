...
namespace MyCreek.Entities.Events.Notifications
{
    public class EventUserEmailer :
        IEventHandler<EntityCreatedEventData<CreekEvent>>,
        ...
        ITransientDependency
    {
        ...
        [UnitOfWork]
        public virtual void HandleEvent(EntityCreatedEventData<CreekEvent> eventData)
        {
