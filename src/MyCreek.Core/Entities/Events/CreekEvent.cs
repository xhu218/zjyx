...
{
    [Table("AppEvents")]
    public class CreekEvent : FullAuditedEntity<Guid>, IMustHaveTenant
    {
        ...
        {
            return Date.Subtract(Clock.Now).TotalHours <= 2.0; //2 hours can be defined as CreekEvent property and determined per event
        }
